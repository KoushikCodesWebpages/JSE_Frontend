            ...
            {selectedJobs.map((job, index) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  <img src={defaultJobImg} alt="Job" className="w-16 h-16 object-contain" />
                  <div>
              ...
              {selectedJob && (
                <>
                  <div className="flex justify-between items-start"><br />
                    <img src={defaultJobImg} alt="Job" className="w-16 h-16 object-contain" /><br />
                    <div>
                    ...
                    <div><br />
                      ...
                      <div className="flex flex-col gap-2 mt-2">
                        <ul className="list-disc pl-5">
                          {selectedJob.skillData[0].value.map((skill, i) => (
