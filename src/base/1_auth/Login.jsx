      ...
      <div className="flex flex-1">
        ...
        <div className="flex flex-1 justify-center items-center p-8 bg-white">
          <div className="max-w-lg w-full">
            <h2 className="text-3xl font-semibold text-center mb-6">Login now</h2><br/><br/>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                required
                className="w-full h-[52px]  px-4 py-4 border border-gray-300 rounded-md text-base focus:outline-none focus:ring-2 focus:ring-[#2c6472] peer pr-10"
                placeholder=" "
              />
              <label className={`absolute left-4 transition-all text-gray-500 text-base
                ${formData.password
              ...
              <button
                type="submit"
                className="w-half h-[40px] bg-[#2c6472] text-white py-3 rounded-[10px] font-semibold hover:bg-[#24525f] transition"
              >
                Login
              </button><br/>
            </form>
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-center text-xl font-medium mb-8">Welcome Back!</h3>
          <DotLottieReact
