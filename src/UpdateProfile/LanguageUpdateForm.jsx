        ...
        <div className='fixed inset-0 bg-white bg-opacity-70 z-50 flex items-center justify-center trasnfrom ease-in-out duration-200'>
            <div className='w-[700px] h-[570px] bg-white flex flex-col shadow rounded-xl px-10 py-5 ' >
                ...
                <div className="flex gap-4 mt-7 mb-5 overflow-x-auto hide-scrollbar transform ease-linear duration-150 snap-x snap-mandatory">
                    <div className="flex-shrink-0  h-8 px-3 py-1.5 text-sm hover:text-white bg-gray-500/20 rounded snap-start hover:bg-[#2c6472] transform ease-in-out duration-200">German</div>
                    <div className="flex-shrink-0  h-8 px-3 py-1.5 text-sm hover:text-white bg-gray-500/20 rounded snap-start hover:bg-[#2c6472] transform ease-in-out duration-200">Tamil</div>
                </div>

                <div className="form-fields flex flex-col gap-4">
                    <div className="flex flex-col w-full gap-4">
                        <label htmlFor="jobtitle" className='text-[15px] text-gray-500'>Language</label>
                    ...
                    <div className='flex gap-4'>
                        <div className="flex flex-col w-full gap-3">
                            <label htmlFor="jobtitle" className='text-[15px] text-gray-500' >Language Certificate (optional)</label>
                    ...
                    <div className='flex gap-4'>
                        <div className="flex flex-col w-full gap-3">
                            <label htmlFor="jobtitle" className='text-[15px] text-gray-500' >Proficiency</label>
                    ...
                    <div className="flex justify-between w-full mt-2">
                        <button className='text-sm text-[#2c6472] font-medium hover:scale-95 transform ease-in-out duration-200'>+ Add Language</button>
